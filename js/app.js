...
function createDownloadLink(blob) {
	...
	link.innerHTML = "Salvar no computador";
	...
	upload.href="#";
	upload.innerHTML = "<div class='btn-audio bg-green mt-3'><i class='fa fa-floppy-o' aria-hidden='true'></i><div class='text-ml'>Salvar</div></div>";
